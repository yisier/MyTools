    ...
    <el-form>
        <el-form-item>
            <el-radio v-model='radioValue' :label="1">
                {{ $t('javaCron.week.weekPlaceholder') }}
            </el-radio>
        </el-form-item>

        <el-form-item>
            <el-radio v-model='radioValue' :label="2">
                {{ $t('javaCron.week.notSpecified') }}
            </el-radio>
        </el-form-item>

        <el-form-item>
            <el-radio v-model='radioValue' :label="3">
                {{ $t('javaCron.week.cycleStart') }}
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="4">
                {{ $t('javaCron.week.averageStart') }}
                <el-input-number v-model='average01' :min="1" :max="4" />
                {{ $t('javaCron.week.weekOfMonth') }}
        ...
        <el-form-item>
            <el-radio v-model='radioValue' :label="5">
                {{ $t('javaCron.week.lastWeekdayOfMonth') }}
...
const weekList = ref([
    { key: 1, value: t('javaCron.week.sunday') },
    { key: 2, value: t('javaCron.week.monday') },
    { key: 3, value: t('javaCron.week.tuesday') },
    { key: 4, value: t('javaCron.week.wednesday') },
    { key: 5, value: t('javaCron.week.thursday') },
    { key: 6, value: t('javaCron.week.friday') },
    { key: 7, value: t('javaCron.week.saturday') }
])
